...
print('Периметр:', int(square) * int(square))
print('Площадь:', int(square) * 4)
rectangle=input('Введите длину прямоугольника:')
rectangle2=input('Введите ширину прямоугольника:')
print('Периметр:', int(rectangle) * 2 + int(rectangle2) * 2)
print('Площадь:', int(rectangle) * int(rectangle2))
```
...
life=input('Введите, какой процент(%) уходит на жизнь:')
print('Вывод:')
print('На ипотеку было потрачено:', int(wages) * int(mortgage) / 100 * 12)
print('Было накоплено:', int(wages) * 12 - int(wages) * int(mortgage) / 100 * 12 - int(wages) * int(life) / 100 * 12)
```
